...
@section('content')
    ...
    <div class="card-actions">
        <a href="{{ url('hub/object') }}" class="button is-danger is-outlined confirm-click" data-text="Are you sure you want to delete this listing?"><i class="fal fa-trash-alt"></i> Delete Listing</a>
    </div>
    <h2 class="card-title">
        <i class="fal fa-building"></i> 6532 N Descartes Dr Coeur d' Alene AL 83815
    </h2>
