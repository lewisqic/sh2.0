...
@section('content')
    ...
    <div class="card-actions">
        <a href="#" class="button is-success is-outlined toggle-content" data-toggle=".new-contact-wrapper"><i class="fal fa-plus-circle "></i> New Contact</a>
    </div>
    <h2 class="card-title">
        <i class="fal fa-address-book"></i> Contacts
    ...
    <div class="search-wrapper is-display-none">
        <div class="card">
            <div class="card-header">
                <div class="card-header-title">Search Contacts</div>
            </div>
    ...
    <div class="new-contact-wrapper is-display-none">
        <div class="card">
            <div class="card-header">
                <div class="card-header-title"><i class="fa fa-plus-circle fa-lg has-text-success has-mr-4"></i> Add New Contact</div>
            </div>
            <div class="card-content">
